...
function setup() {
  ...
  heart1=createSprite(360,40,20,20)
  heart2=createSprite(330,40,20,20)
...
function draw() {
 ...
 //   mosquito.debug=true;
 gameover.depth=potionsGroup.depth+2 
 gameover.depth=obstaclesGroup.depth+2
 gameover.depth=netGroup.depth+2
 restart.depth=potionsGroup.depth+2 
 restart.depth=obstaclesGroup.depth+2
 restart.depth=netGroup.depth+2
